...
import { Database, ExternalLink, MoreVertical, Trash2, Settings, ArrowLeft } from 'lucide-react';
...
export function ProjectCard({
  ...
  const [stats, setStats] = useState<ProjectStats>({ records: null, tables: null, lastImport: null });
