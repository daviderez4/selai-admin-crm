...
export async function POST(
  ...
  try {
    ...
    if (isLocalProject) {
      ...
      console.log('Using main Supabase for local project:', project.name, 'table:', TABLE_NAME);
    } else {
      ...
      console.log('Importing to external project database:', project.name, 'table:', TABLE_NAME);
    }
